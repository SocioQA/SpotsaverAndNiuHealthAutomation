...
public class Dashboard_New {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
        ...
        actions.build().perform();
        Thread.sleep(4000);
        //Move to regular hours and click.
      //  actions.moveToElement(driver.findElement(By.xpath("html/body/div[1]/div/div[4]/form/div[5]/svg"))).click().build().perform();
//        WebElement regHours= driver.findElement(By.xpath("//div[contains(@class,'MuiBox-root css-bse62r')]"));
//        regHours.click();
        // Locate the element using XPath and click it
        WebElement regularHoursElement = driver.findElement(By.xpath("//p[contains(text(), 'Regular Hours')]"));
        // Use JavaScript to click the element
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", regularHoursElement);
	}      
}
